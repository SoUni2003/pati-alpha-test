...
const MainButton: React.FC<MainButtonProps> = ({ to, className = "", children, title, ...props }) => {
  const baseClasses = `bg-black text-white font-bold font-nunito py-4 px-8 rounded-md text-base lg:text-lg hover:bg-gray-800 transition-colors w-full lg:w-auto min-w-[460px] flex justify-center items-center text-center ${className}`;
