...
const MainButton: React.FC<MainButtonProps> = ({ to, className = '', children, title, ...props }) => {
  const baseClasses = `bg-black text-white font-bold font-nunito py-4 px-4 md:px-8 rounded-md text-base md:text-lg hover:bg-gray-800 transition-colors w-full md:w-auto md:min-w-[460px] flex justify-center items-center text-center ${className}`;
