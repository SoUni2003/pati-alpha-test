    ...
    <section className='lg:py-6'>
      <div className='page-container'>
        <div className='text-center mb-10  max-w-[800px] mx-auto'>
          ...
          <p className='mt-3 font-nunito text-base lg:text-lg text-sculptique-text'>All reviews verified from actual paying customers</p>
        </div>

        <div className='mb-4'>
          <h3 className='text-center font-trirong text-[22.5px] lg:text-2xl  text-sculptique-text'>Customer Reviews</h3>
          ...
          <div className='flex flex-col lg:flex-row items-stretch border-b border-sculptique-pink/10'>
            <div className='flex-1 flex flex-col items-center lg:items-start justify-center space-y-2 py-6 lg:pr-2'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-base font-montserrat text-sculptique-secondary text-nowrap'>4.67 out of 5</span>
              </div>
          ...
          {currentReviews.map((review) => (
            <div key={review.id} className='border-b border-sculptique-pink/10 pb-8'>
              ...
              <div className='flex flex-col sm:flex-row sm:items-center gap-3 my-3'>
                ...
                <span className='text-[#7b7b7b] font-montserrat text-[12.8px] lg:hidden mt-1'>{review.date}</span>
              </div>
              ...
              return (
                <button
                  ...
                  className={`w-8 h-8 flex font-montserrat items-center justify-center rounded transition-colors ${
                    currentPage === page ? 'text-[#7b7b7b] font-bold text-2xl' : 'text-sculptique-pink hover:bg-pink-50'
                  }`}>
                  {page}
                </button>
              );
