          ...
          {SYMPTOMS.map((symptom, idx) => (
            <div
              ...
              <div className='w-[150px] lg:w-[220px] h-full lg:h-[171px] shrink-0 overflow-hidden rounded-t-xl bg-sculptique-cream'>
                <img src={symptom.image} alt='' className='h-full w-full object-cover' loading='lazy' />
              </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[100px] items-center'>
            <div className='space-y-1.5'>
              <p className='font-nunito text-base lg:text-lg text-sculptique-text leading-[1.3]'>
                ...
                <span className='font-bold'>3-4 liters of cellular waste and excess fluid every single day.</span>
              </p>

              <p className='font-nunito text-base lg:text-lg'>When it's working properly, you don't even know it exists.</p>
                ...
                {['Waste gets drained away', 'Fluid stays balanced.', 'Your body feels light and energized.'].map((txt) => (
                  <li key={txt} className='flex items-center gap-x-2'>
                    <img
                      ...
                      className='w-5 h-5'
                    />
                    <span className='text-base lg:text-lg font-nunito text-[#0c7c00] font-semibold line-[1.3]'>{txt}</span>
                  </li>
                ))}
              </ul>
              ...
              <ul className='space-y-2'>
                {['Vessel pumping weakens.', 'One-way valves fail.', 'Protein clogs form.', 'Vessel walls become leaky.'].map((txt) => (
                  <li key={txt} className='flex items-center gap-x-2 font-medium'>
                    ...
                    <span className='text-base lg:text-lg font-nunito text-[#a60003] font-semibold line-[1.3]'>{txt}</span>
                  </li>
                ))}
              </ul>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[100px] items-center mt-12 lg:mt-20'>
          ...
          <div className='space-y-2 order-1 lg:order-2'>
            ...
            <p className='text-lg text-sculptique-text leading-relaxed'>
              That gallon of fluid your body should be draining every 24 hours? It's pooling in your stomach, your legs, your face—anywhere
              gravity and tissue structure allow it to settle.
            </p>

            <div className='bg-[#ffe3e3] rounded-xl px-4 py-2 !my-4'>
              <p className='text-base sm:text-lg  text-black'>
                The metabolic waste your cells produce overnight? It's still sitting there at noon. At dinner. While you're trying to fall
                asleep.
              </p>
              ...
              <ul className='space-y-2 mt-1'>
                {[
                  ...
                  <li key={txt} className='flex items-center gap-x-2 font-medium'>
                    ...
                    <span className='text-base lg:text-lg font-nunito text-[#a60003] font-bold line-[1.3]'>{txt}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <p className='font-nunito text-base lg:text-lg font-semibold'>
              The longer this goes on, the worse it gets. More congestion. More inflammation. More pressure on an already compromised
              system.
            </p>
          </div>
        </div>
