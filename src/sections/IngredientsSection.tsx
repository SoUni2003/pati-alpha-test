...
const INGREDIENTS = [
  ...
  },
  {
    ...
    description:
      "Enzymatically breaks down the protein complexes that clog lymphatic vessels, allowing fluid to flow freely again. Acts as a biologicalèa pipe cleaner for your lymphatic system.",
  },
  {
    name: "Rutin (100mg)",
    ...
    description:
      "A powerful bioflavonoid that reinforces the structural integrity of lymphatic capillaries, reducing permeability and preventing fluid from leaking back into tissues.",
  },
  {
    ...
    description:
      "Potent anti-inflammatory that calms swollen tissues, reducing pressure on lymphatic vessels and facilitating easier drainage.",
  },
  {
    ...
    description:
      "Enhances macrophage activity to engulf and clear cellular waste products and toxins that stagnate in a sluggish lymphatic system.",
  },
  {
    ...
    description:
      "Rich in iodine to support thyroid function and metabolic rate, ensuring your body has the energy required to drive lymphatic circulation.",
  },
  {
    ...
    description:
      "Provides high levels of Vitamin C and flavonoids to protect lymphatic vessels from oxidative stress and free radical damage.",
  },
];
                ...
                >
                  <div className="flex items-center gap-2 mb-4 w-full justify-center">
                    <img
                      ...
                      className="w-4 h-4"
                    />
                    <span className="text-base font-nunito text-[#0c7c00]">
                      {ingredient.benefit}
                    </span>
                  </div>
                  ...
                  <div className="w-full flex flex-row lg:flex-col items-center gap-3 lg:gap-0">
                    ...
                    <div className="flex-1 w-full flex items-center justify-between lg:pt-2 pl-3 md:pl-0">
                      <div className="text-left">
                        <h3 className="font-trirong text-base font-semibold text-sculptique-text leading-[1.3]">
                          {ingredient.name}
                        </h3>
                      </div>
                      <svg
                  ...
                  <div
                    className={`grid transition-all duration-500 ease-in-out w-full text-left ${expandedIndices.includes(idx) ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}
                  >
