        ...
        <div className='flex flex-col lg:flex-row gap-12 lg:gap-16 items-center'>
          <div className='flex-1 w-full lg:w-1/2 flex flex-col items-start text-left'>
            ...
            <p className='text-base lg:text-xl font-nunito leading-[1.3] text-sculptique-text mb-4 font-medium'>
              You deserve to feel like yourself again. To wake up without puffiness. To see your ankles. To look in the mirror and recognize
              the vibrant woman staring back. To have energy for the people you love.
            </p>
