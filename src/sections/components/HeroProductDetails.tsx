      ...
      <ul className='mt-4 space-y-4'>
        {SELLING_POINTS.map((point) => (
          <li key={point.text} className='flex items-center gap-3'>
            <img src={point.icon} alt='' className='mt-0.5 h-10 w-10 flex-shrink-0 sm:h-[49px] sm:w-[49px]' loading='lazy' />
            <p className='text-sm leading-5 sm:text-base sm:leading-6'>{point.text}</p>
          </li>
        ))}
      </ul>
        ...
        <div className='flex flex-col sm:flex-row sm:items-start sm:justify-start sm:gap-4'>
          <div className='flex flex-col sm:flex-row sm:items-center sm:gap-4'>
            ...
            <div className='text-[13px] leading-6 text-sculptique-text sm:max-w-md sm:text-[13px]'>
              <span className='font-semibold'>373 clinicians</span> share this on
