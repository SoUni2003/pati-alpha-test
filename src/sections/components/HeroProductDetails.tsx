      ...
      <ul className='mt-4 space-y-4'>
        {SELLING_POINTS.map((point) => (
          <li key={point.text} className='flex items-center gap-3'>
            ...
            <p className='leading-[1.3] font-nunito text-base font-medium'>{point.text}</p>
          </li>
        ))}
      </ul>
      <div id='maximized' className='relative mt-4 md:mt-6 w-full bg-white mb-10 md:px-2'>
        <div className='flex flex-row md:items-start md:justify-start md:gap-3'>
          <div className='flex flex-row md:items-center gap-2 md:gap-4'>
            <div className='flex items-center gap-2 text-sculptique-text'>
              <svg xmlns='http://www.w3.org/2000/svg' width='13' height='25' viewBox='0 0 17 35' fill='black' className='md:w-[17px] md:h-10'>
                <path
              ...
              <p className='font-lora text-[10px] md:text-base text-center font-semibold leading-tight text-sculptique-text'>
                Clinicians'
                <br />
                Choice
              </p>
              <span className='inline-flex' aria-hidden='true'>
                <svg xmlns='http://www.w3.org/2000/svg' className='h-[25px] w-[13px] md:h-10 md:w-[17px]' viewBox='0 0 17 35' fill='black'>
                  <path
            ...
            <div className='text-[10px] font-lora leading-[1.3] text-sculptique-text md:max-w-md md:text-[13px]'>
              ...
              <div className='flex gap-1 lg:gap-3 flex-row items-center md:gap-4'>
          ...
          <button type='button' className='absolute md:right-2 right-8 -top-0.5 md:top-3 md:static flex h-3 md:h-4 w-3 md:w-4 items-center justify-center rounded-2xl bg-neutral-200/80 text-sculptique-text transition hover:bg-neutral-300 shadow-sm border border-neutral-300' id='close-button' aria-label='Click to minimize banner'>
