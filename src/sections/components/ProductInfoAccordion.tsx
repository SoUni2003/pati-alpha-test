  ...
  return (
    <div className='mt-4 flex flex-col gap-6 font-sans'>
      <div className='flex flex-col gap-4'>
        ...
        <button
          type='button'
          className='w-full rounded-lg font-montserrat bg-black py-3 text-center text-lg font-bold uppercase tracking-wider text-white shadow-md transition hover:bg-neutral-800 hover:shadow-lg'>
          Add to cart
        </button>
        ...
        <div className='w-full overflow-hidden rounded-xl'>
          <img
            ...
            onError={(e) => {
              (e.target as HTMLImageElement).src = 'https://placehold.co/600x200/000000/FFF?text=NEW+YEAR+NEW+ME+BANNER';
            }}
          />
        </div>
      </div>
      ...
      <div className='relative overflow-hidden rounded-2xl bg-sculptique-yellow p-3'>
        ...
        <p className='mt-2 font-nunito font-medium text-base leading-[1.3] '>
          After years of hiding under coverups, picking apart my body, and feeling disconnected, I finally feel at ease again. I feel less
          bloated, lighter, like my body is working with me not against me. These past months, I've been present. Even my marriage feels
          renewed, not just in how I look but in how I feel. It's hard to explain, but once you try it you'll get it. I'd recommend this to
          my closest friends without question.
        </p>
      </div>
